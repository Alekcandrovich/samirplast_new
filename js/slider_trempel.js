...
productDetail_1.addEventListener('click', () => {
  const images = [
    { imageSrc: '../images/trempel_1-1.jpg', text: 'Текст для картинки 1' },
    { imageSrc: '../images/trempel_1-2.jpg', text: 'Текст для картинки 2' },
    { imageSrc: '../images/trempel_1-3.jpg', text: 'Текст для картинки 3' },
    { imageSrc: '../images/trempel_1-4.jpg', text: 'Текст для картинки 4' },
  ];
