...
productDetail_1.addEventListener('click', () => {
  const images = [
    { imageSrc: '../images/bopp_1.jpg', text: 'Текст для картинки 2' },
    { imageSrc: '../images/bopp_2.jpg', text: 'Текст для картинки 1' },
    { imageSrc: '../images/bopp_3.jpg', text: 'Текст для картинки 3' },
  ];
...
productDetail_2.addEventListener('click', () => {
  const images = [
    { imageSrc: '../images/bopp_3.jpg', text: 'Текст для картинки 1' },
    { imageSrc: '../images/bopp_2.jpg', text: 'Текст для картинки 2' },
  ];
