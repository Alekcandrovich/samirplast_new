...
productDetail_1.addEventListener('click', () => {
  const images = [
    { imageSrc: '../images/paket_1-1.jpg', text: 'Слайд 1 з 3 (Пакети з поліетиленової плівки)' },
    { imageSrc: '../images/paket_1-2.jpg', text: 'Слайд 2 з 3 (Пакети з поліетиленової плівки)' },
    { imageSrc: '../images/paket_1-3.jpg', text: 'Слайд 3 з 3 (Пакети з поліетиленової плівки)' },
  ];
