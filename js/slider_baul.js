...
productDetail_1.addEventListener('click', () => {
  const images = [
    { imageSrc: '../images/baul_1-1.jpg', text: 'Текст для картинки 1' },
    { imageSrc: '../images/baul_1-2.jpg', text: 'Текст для картинки 2' },
    { imageSrc: '../images/baul_1-3.jpg', text: 'Текст для картинки 3' },
    { imageSrc: '../images/baul_1-4.jpg', text: 'Текст для картинки 4' },
  ];
...
productDetail_2.addEventListener('click', () => {
  const images = [
    { imageSrc: '../images/no_image_2.jpg', text: 'Текст для картинки 1' },
